                            ...
                            <table align="center" class="style1" style="border-bottom-style: ridge; border-width: medium; border-color: #9933FF">
                                <tr>
                                    <td class="style8" align="center" rowspan="2">
                                        <asp:Image ID="Image1" runat="server" Height="53px" ImageUrl="~/Images/ShoppingCart.jpg" Width="72px" />
                                        &nbsp;
                                    </td>
                                    <td class="style6" rowspan="2">
                                        <asp:LinkButton ID="lblLogo" runat="server" Text="ShoppingHeart" Font-Names="Eras Demi ITC" Font-Size="20pt" ForeColor="#6600CC" OnClick="lblLogo_Click"></asp:LinkButton>
                                        <br />
                                        For Those Who love Shopping 
                                    </td>
                                    <td class="style7" rowspan="2">
                                        <asp:Image ID="Image3" runat="server" Height="67px" ImageUrl="~/Images/swords-pavilions-upper-mall.jpg" Width="282px" />
                                    </td>
                                    <td rowspan="2" align="right">
                                        <asp:Image ID="Image2" runat="server" Height="53px" ImageUrl="~/Images/shopping_cart.png" Width="70px" />
                                    </td>
                                    <td align="left">
                    ...
                    <tr>
                        <td>
                            <table align="center" class="style1">
                                <tr>
                                    <td class="style2" valign="top">
                                        <asp:Panel ID="pnlProducts" runat="server" ScrollBars="Auto" Height="500px" BorderColor="Black" BorderStyle="Inset" BorderWidth="1px">
                                            <asp:DataList ID="dlProducts" runat="server" RepeatColumns="3" Width="100%" Font-Bold="False" Font-Italic="False" Font-Overline="false" Font-Strikeout="false" Font-Underline="false">
                                                <ItemTemplate>
                                                    <div align="left">
                                                        <table cellspacing="1" class="style4" style="border: 1px ridge #9900FF">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    Price:<asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label><asp:Image ID="imgStar" runat="server" Visiable="false" ImageUrl="~/Images/GreenStar.jpg" />
                                                                    
                                                                    Stock:&nbsp;
                                                                     <asp:Label ID="lblAvailableStock" runat="server" Text='<%# Eval("AvailableStock") %>' ToolTip="Available Stock" ForeColor="Red" Font-Bold="true"></asp:Label>
                                            ...
                                            <table align="center" cellspacing="1">
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <asp:DataList ID="d1CartProducts" runat="server" RepeatColumns="3" Font-Bold="false" Font-Italic="false" Font-Overline="false" Font-Strikeout="false" Font-Underline="false" Width="551px">
                                                            <ItemTemplate>
                                                                <div align="left">
                                                                    <table cellspacing="1" style="border: 1px ridge #9900FF; text-align: center; width: 172px;">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                &nbsp;x&nbsp;
                                                                                <asp:TextBox ID="txtProductQuantity" runat="server" width="10px" Height="10px" MaxLenght="1" OnTextChanged="txtProductQuantity_TextChanged" AutoPostBack="true" Text='<%# Eval("ProductQuantity") %>' ></asp:TextBox>
                                                                                <asp:HiddenField ID="hfProductID" runat="server" Value='<%# Eval("ProductID") %>' />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <hr />
                                                                                <asp:Button ID="btnRemoveFromCart" runat="server" CommandArgument='<%# Eval("ProductID") %>' Text="RemoveFromCart" Width="100%" BorderColor="Black" BorderStyle="Inset" BorderWidth="1px" Onclick="btnRemoveFromCart_Click" CausesValidation="false" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                    ...
                                    <td class="style3" valign="top" align="center">
                                        <asp:Panel ID="pnlCategories" runat="server" ScrollBars="Auto" Height="500px" BorderColor="Black" BorderStyle="Inset" BorderWidth="1px">
                                            <asp:DataList ID="dlCategories" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="252px">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbnCategory" runat="server" Text='<%# Eval("CategoryName") %>' OnClick="lbtnCategory_Click" CommandArgument='<%# Eval("CategoryID") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            ...
                                            <table style="width: 258px">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidator="txtCustomerPhoneNo" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCustomerName" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                ...
                                                <tr>
                                                    <td align="left">&nbsp;<asp:TextBox ID="txtCustomerAddress" runat="server" Width="227px" Height="81px" TextMode="MultiLine"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnPlaceOrder" runat="server" OnClick="btnPlaceOrder_Click" Style="font-weight: 700" Text="PlaceOrder" Width="90px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCustomerEmailID" ErrorMessage="Please Enter Valid EmailID" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Panel ID="pnlEmptyCart" runat="server" Visiable="false">
                                            <div style="text-align: center;">
                                                ...
                                                <br />
                                                <br />
                                                <asp:Image ID="Image4" runat="server" ImageUrl="~/Images/EmptyCart.png" Width="500px" />
                                                <br />
                                                <br />
                                                <br />
                                                <br />
                                        ...
                                        <asp:Panel ID="pnlOrderPlacedSuccessfully" runat="server" Visibale="false">
                                            <div style="text-align: center">
                                                <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/happy-shopping.jpg" Width="500px" /><br />
                                                <br />
                                                <label>
                                                ...
                                                <br />
                                                <br />
                                                Transaction Details Are sent At emailed provided By You.<br />
                                                <br />
                                                <br />
                                                ...
                                                <br />
                                                <br />
                                                <a href="TrackYourOrder.aspx" target="_blank">Track Your Transactions Details Here </a>
                                                <br />
                                                <br />
                                                <br />
                                            </div>
                                ...
                                <tr>
                                    <td colspan="2" align="center" style="border:thin ridge #9900FF">
                                        &nbsp;&copy;Hesham Essam || <a href="Admin/Login.aspx" target="_blank">AdminPanel</a> 
                                    </td>
                                </tr>
                            </table>
                        </td>
